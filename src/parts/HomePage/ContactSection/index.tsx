...
function ContactSection() {
  ...
  return (
    <>
      <section
        id="contact"
        className="mt-16 md:mt-64 pb-24  bg-bgBlack text-white flex flex-col"
      >
        <div className="container mx-auto px-5 md:px-20 flex flex-col text-center items-center justify-center gap-8 md:gap-10">
          <h3 className="font-semibold text-xl md:text-2xl">What’s Next ?</h3>
          ...
          <div className="mt-8 md:mt-0 md:fixed left-0 bottom-0 px-16 flex md:flex-col gap-4 items-center justify-center">
            <div className="flex flex-row md:flex-col justify-center items-center gap-8">
              <Link className="" to={""} target="_blank">
                <Linkedin className="w-6 md:w-10 hover:text-customGreen text-white" />
              </Link>
              <Link className="" to={""} target="_blank">
                <Github className="w-6 md:w-10 hover:text-customGreen text-white" />
              </Link>
              <Link className="" to={""} target="_blank">
                <Instagram className="w-6 md:w-10 hover:text-customGreen text-white" />
              </Link>
            </div>
            <div className="hidden md:block mx-8 h-[200px] border-l-4 border-white">
              {" "}
            </div>
          </div>
          <Link
            to={"mailto:oriastan999@gmail.com"}
            className={`mt-8 md:mt-24 text-base font-bold bg-bgBlack rounded-2xl px-4 py-2 hover:border-2 transform transition-transform duration-500 hover:scale-105 border-b-2 border-white`}
          >
            Say Hello
          </Link>
        </div>
